@extends('layouts.web')
@section('titulo')
<title> {{$municipio->denominacion}} </title>
@endsection
@section('contenido')
            ...
            <div>
                    <div class="row">
                            <div style="text-align: center">
                                <h3 style="color: #45A041; padding: 10px">{{$municipio->denominacion}}</h3>
                            </div>
                            <input type="hidden" id="lat" value="{{$municipio->lat}}" >
                            <input type="hidden" id="lng" value="{{$municipio->lng}}" >
                            <input type="hidden" id="esc" value="{{$municipio->id}}" >
                            <input type="hidden" id="esc-deno" value="{{$municipio->denominacion}}" >
                            ...
                            <div class="nav-tabs-custom" style="padding: 5px">
                                    <ul class="nav nav-tabs">
                                      ...
                                      <li class="tab-escuela"><a target="_blank" href="https://www.google.com.ar/maps/dir//{{$municipio->lat}},{{$municipio->lng}}/data=!3m1!4b1!4m2!4m1!3e3">
                                    ...
                                    <div class="tab-content" style="width: 90%; margin: 0 auto">
                                        <div class="tab-pane" id="lineas" >
                                                <br/>
                                               <p style="font-size:16px">Recorridos cercanos en un radio de 500 mts. a la municipio seleccionada</p>
