@extends('layouts.web')
@section('titulo')
<title> Centros Municipales </title>
@endsection
@section('contenido')
                    ...
                    <div class="row">
                            <div class="nav-tabs-custom">
                                    <ul class="nav nav-tabs">
                                      ...
                                      <li class="tab-item {{ (request()->query('tab') == 'municipios' ? 'active' : '')}}"><a href="#municipios" data-toggle="tab"  >Municipios</a></li>
                                    </ul>
                                    <hr>
                                    ...
                                    <div class="tab-pane {{ (request()->query('tab') == 'search' ? 'active' : 'active')}}" id="search" style="min-height: 300px">
                                            <br/>
                                            <form id="frSearch" method="GET" action="{{route('site.municipios')}}"  role="search" class="form-inline">
                                            ...
                                            <ul class="list-group">
                                                @foreach($resultados as $item)
                                                    <li class="list-group-item list-group-item-action">
                                                        <a style="text-decoration: none !important; color: inherit;" href="{{route('sitio.municipio_detalle', $item->id)}}">
                                    ...
                                    <div class="tab-pane {{ (request()->query('tab') == 'municipios' ? 'active' : '')}}" id="municipios">
                                            @if($municipios)
                                                <ul class="list-group">
                                                    ...
                                                    @endforeach
                                                    <li class="list-group-item list-group-item-action">
                                                            {!! $municipios->appends(['tab' => 'capital'])->links() !!}
                                                    </li>
                                                </ul>
